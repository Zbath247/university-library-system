  ...
  seedInitialData(force = false) {
    ...
    if (force || !this.data.users || this.data.users.length === 0) {
      const sampleUsers = [
        ...
        {
          id: 2,
          university_id: 'PROF-8820',
          full_name: 'Dr. Arthur Sterling',
          email: 'arthur.sterling@university.edu',
        ...
        {
          id: 3,
          university_id: 'LEC-4402',
          full_name: 'Dr. Marcus Holloway',
          email: 'marcus.h@university.edu',
        ...
        {
          id: 5,
          university_id: 'STU-1024',
          full_name: 'Sophia Chen',
          email: 'sophia.chen@student.university.edu',
        ...
        {
          id: 6,
          university_id: 'STU-2048',
          full_name: 'Liam Patel',
          email: 'liam.patel@student.university.edu',
          phone: '+1 (555) 789-0123',
          role_id: 1,
          department_id: 6,
          research_field: 'Epigenetic Biomarkers in Early Oncology Detection',
          default_purpose: 'Capstone Experimental Synthesis',
          created_at: new Date(Date.now() - 8 * 86400000).toISOString()
        },
        {
          id: 7,
          university_id: 'SCH-7701',
