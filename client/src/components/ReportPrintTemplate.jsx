  ...
  return (
    <div style={{ display: 'none' }}>
      ...
      >
        ...
        {/* Footer Address */}
        <div style={{ marginTop: '100px', textAlign: 'center', fontFamily: '"Battambang", "Khmer OS Battambang", sans-serif', fontSize: '9pt', color: '#4b5563', borderTop: '1px solid #e5e7eb', paddingTop: '15px' }}>
