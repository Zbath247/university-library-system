...
const translations = {
  km: {
    ...
    inputPlaceholder: 'វាយបញ្ចូលអត្តលេខសម្គាល់ (ឧ. STU-2024-001, LEC-002)...',
  ...
  en: {
    ...
    inputPlaceholder: 'Enter University ID (e.g. STU-2024-001, LEC-002)...',
    ...
    idPlaceholder: 'e.g. STU-2026-089',
