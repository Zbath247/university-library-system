...
const translations = {
  km: {
    ...
    fullNamePlaceholder: 'ឧ. ម៉ុក សម្បត្តិ',
    ...
    bookTitleLabel: 'ចំណងជើង ឬឈ្មោះសៀវភៅ',
    bookTitleBorrowPlaceholder: 'ឧ. Data Structures & Algorithms, កុលាបប៉ៃលិន...',
    bookTitleReturnPlaceholder: 'ឧ. ឈ្មោះសៀវភៅ ឬលេខកូដសៀវភៅដែលត្រូវសង...',
    bookAgreementBorrow: 'ខ្ញុំសូមបញ្ជាក់ និងយល់ព្រមតាមបទបញ្ជាផ្ទៃក្នុងរបស់បណ្ណាល័យ ក្នុងការខ្ចីសៀវភៅ និងសន្យាថែរក្សា ព្រមទាំងប្រគល់សងទាន់ពេលវេលាកំណត់។',
    bookAgreementReturn: 'ខ្ញុំសូមបញ្ជាក់ថាបានត្រួតពិនិត្យ និងប្រគល់សៀវភៅជូនបណ្ណាល័យគ្រប់ចំនួន ព្រមទាំងមានសភាពល្អពេញលេញ។',
    agreementRequiredError: 'សូមចុចធីកយល់ព្រមលើលក្ខខណ្ឌមុននឹងបន្ត!',
    ...
    phone: 'លេខទូរស័ព្ទ ឬ លេខTelegram',
    ...
    titleLibraryVisits: 'កំណត់ត្រាចូលបណ្ណាល័យ',
    subLibraryVisits: 'គ្រប់គ្រង និងតាមដានរាល់កំណត់ត្រាចូលបណ្ណាល័យរបស់សមាជិក',
    navLibraryTransactions: 'កំណត់ត្រាខ្ចីនឹងសង',
    titleLibraryTransactions: 'កំណត់ត្រាខ្ចីនឹងសង',
    subLibraryTransactions: 'គ្រប់គ្រង និងតាមដានរាល់កំណត់ត្រាខ្ចីនិងសងសៀវភៅរបស់សមាជិក',
    ...
    statPeakHour: 'ម៉ោងបច្ចុប្បន្ន',
    statPeakHourDesc: 'ម៉ោងជាក់ស្តែងក្នុងបន្ទប់បណ្ណាល័យ',
    statTotalVisits: 'ចំនួនចូលបណ្ណាល័យសរុប',
    statTotalVisitsDesc: 'ចំនួនដងសរុបដែលបានកត់ត្រាក្នុងប្រព័ន្ធ',
    ...
    btnReset: 'សម្អាតទិន្នន័យ (Reset)',
    btnBackup: 'Backup',
    btnRestore: 'Restore',
    btnCsv: 'CSV',
    btnExcel: 'Excel Summary',
    btnWord: 'Word',
    btnPdf: 'PDF',
    filterAllMonths: 'គ្រប់ខែ (All Months)',
    filterAllYears: 'គ្រប់ឆ្នាំ (All Years)',
    month1: 'មករា (Jan)',
    month2: 'កុម្ភៈ (Feb)',
    month3: 'មីនា (Mar)',
    month4: 'មេសា (Apr)',
    ...
    month9: 'កញ្ញា (Sep)',
    month10: 'តុលា (Oct)',
    month11: 'វិច្ឆិកា (Nov)',
    month12: 'ធ្នូ (Dec)',
    catAll: 'ទាំងអស់ (All)',
    catVisit: 'ចូលបណ្ណាល័យ',
    catBorrow: 'ខ្ចីសៀវភៅ',
    catReturn: 'សងសៀវភៅ',
  ...
  en: {
    ...
    fullName: 'Full Name',
    fullNamePlaceholder: 'e.g. Mok Sambath or Dr. Emily Watson',
    ...
    bookTitleLabel: 'Book Title / Identifier',
    bookTitleBorrowPlaceholder: 'e.g. Clean Code, Introduction to Algorithms...',
    bookTitleReturnPlaceholder: 'e.g. Book title or barcode number being returned...',
    bookAgreementBorrow: 'I confirm and agree to the library book borrowing policy, and promise to keep the book in good condition and return it on time.',
    bookAgreementReturn: 'I confirm that the book(s) are being returned in full and in original good condition.',
    agreementRequiredError: 'Please agree to the confirmation terms to proceed!',
    bookTitleRequiredError: 'Please specify the book title or identifier!',
    email: 'University Email (Optional)',
    emailPlaceholder: 'name@university.edu.kh',
    phone: 'Phone or Telegram Number (Optional)',
    ...
    titleLibraryVisits: 'Library Visit Logs',
    subLibraryVisits: 'Manage and track all library visit logs of members',
    navLibraryTransactions: 'Borrow & Return Logs',
    titleLibraryTransactions: 'Borrow & Return Logs',
    subLibraryTransactions: 'Manage and track all book borrow and return logs of members',
    ...
    logsSub: 'Manage and track all member attendance records',
    ...
    statPeakHourDesc: 'Busiest time of the day',
    statTotalVisits: 'Total Library Visits',
    statTotalVisitsDesc: 'Total actual entries recorded',
